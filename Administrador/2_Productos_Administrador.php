...
<head>
    ...
    <link href="../css/Administrador/2_Productos_Administrador.css" rel="stylesheet" type="text/css" media="screen" />
  </head>
  <style>
    .eliminar{
      border-radius: 10px;
...
<table cellspacing="0" class="productos">
            <thead>
                <tr>
                    <th class="thead">Nombre Producto</th>
                    <th class="thead">Precio</th>
                    <th  class="descripcion">Descripción</th>
                    <th class="thead">Serial</th>
